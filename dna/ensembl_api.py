...
if __name__ == "__main__":  # pragma: no cover, extracting data from Ensembl
    ...
    files = [
        ...
        "saccharomyces_cerevisiae_genes.txt",
        "chlamydomonas_reinhardtii_genes.txt",
        "galdieria_sulphuraria.txt",
        "cyanidioschyzon_merolae.txt",
    ]

    # Prepend the folder path to each file path
    files = [folder + path for path in files]

    get_data_as_csv(files, "csv_files")
